...
モンキーパッチを明示的に悪用したのがprototype pollutionであり、セキュリティ的にも良くない。

### 項目48

まとめ回。

OSS公式であっても信用できないことを想定しなければならないことがあるのが恐ろしい。しかし、逆に言うと、OSS開発者より弱い私たちは当然このような脆弱なTypeScriptを書いてしまうので、この節のようなユースケースと対処法を忘れないことが大事だと感じた。
